...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(204, 6);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(63, 13);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Wygrane Y:";
			// 
			// lblLicznikX
			// 
			this->lblLicznikX->AutoSize = true;
			this->lblLicznikX->Location = System::Drawing::Point(34, 29);
			this->lblLicznikX->Name = L"lblLicznikX";
			this->lblLicznikX->Size = System::Drawing::Size(13, 13);
			this->lblLicznikX->TabIndex = 2;
			this->lblLicznikX->Text = L"0";
			// 
			// lblLicznikO
			// 
			this->lblLicznikO->AutoSize = true;
			this->lblLicznikO->Location = System::Drawing::Point(230, 29);
			this->lblLicznikO->Name = L"lblLicznikO";
			this->lblLicznikO->Size = System::Drawing::Size(13, 13);
			this->lblLicznikO->TabIndex = 3;
			this->lblLicznikO->Text = L"0";
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(15, 361);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(197, 361);
			...
			this->A1->Location = System::Drawing::Point(15, 74);
			this->A1->Name = L"A1";
			...
			this->B1->Location = System::Drawing::Point(102, 65);
			this->B1->Name = L"B1";
			...
			this->C1->Location = System::Drawing::Point(207, 53);
			this->C1->Name = L"C1";
			...
			this->B2->Location = System::Drawing::Point(112, 154);
			this->B2->Name = L"B2";
			...
			this->B3->Location = System::Drawing::Point(114, 252);
			this->B3->Name = L"B3";
			...
			this->C3->Location = System::Drawing::Point(207, 243);
			this->C3->Name = L"C3";
			...
			this->C2->Location = System::Drawing::Point(207, 149);
			this->C2->Name = L"C2";
			...
			this->A3->Location = System::Drawing::Point(15, 262);
			this->A3->Name = L"A3";
			...
			this->A2->Location = System::Drawing::Point(15, 166);
			this->A2->Name = L"A2";
	...
	private: System::Void graj(System::Object^  sender, System::EventArgs^  e) 
	{
		...
		wygrana();
			 ...
			 private: Void wygrana()
			 {
				 ...
				 if (wygral)
				 {
					 for each (Control^ element in this->Controls)     // zablokowanie kontrolek
					 {
						 if (element->GetType() == PictureBox::typeid)						 						 
						 element->Enabled = false;
					 }
					 if (wcisniety)                                    //liczba wygranych
					 {
						 licznikO++;
					 ...
					 MessageBox::Show("Wygrana: " + ktowygral, "Kó³ko i Krzy¿yk",MessageBoxButtons::OK, MessageBoxIcon::Asterisk);
				 }

				 

			 }
	private: Void reset()                                         // funkcja restartujaca
	{
		for each (Control^ element in this->Controls)
		{
			try
			{
				PictureBox^ zdjecie = (PictureBox^)element;       // blok wyjatku
			...
			catch (...)                                            // blok wylapuje wszystko
			{

			}
		}
	}
                 private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) //Nowa Gra
                   {					
					 reset();
                    }
                 private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e)  // Reset
                    {
					 reset();
